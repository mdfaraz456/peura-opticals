...
if (isset($_REQUEST["delete"]) && $_REQUEST["delete"] == "y") {
  ...
  try{
    $sqlDelete = $db->execute("DELETE FROM `sub_category` WHERE `id` = '$id'");
...
if (isset($_REQUEST["status"])) {
  ...
  $sqlStatus = $db->execute("UPDATE `sub_category` SET `status` = '$status' WHERE `id` = '$id'");
  if ($sqlStatus == true) {
                  ...
                  <div class="table-responsive">
                    <table id="example1" class="table table-bordered table-striped">
                      ...
                      <tbody>
                        <?php
                        $i = 1;
                        $subcateogryQuery = $subcategory->getAllSubCategories();
                        foreach ($subcateogryQuery as $row):
                        $categoryName = $subcategory->getCategories($row["category_id"]); ?>
                          <tr>
                            <td><?php echo $i++; ?></td>
                            ...
                            <td>
                              <a href="add-subcategory.php?id=<?php echo base64_encode($row["id"]); ?>"><i class="fa fa-edit"></i></a>
                              ||
