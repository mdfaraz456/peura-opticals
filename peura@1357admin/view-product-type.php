...
if (isset($_REQUEST['delete']) && $_REQUEST['delete'] == 'y') {
  ...
  try {
    ...
    $_SESSION['errmsg'] = 'Cannot delete record: Related records exist in Sub Category table. Please remove the related records first.';
  }
...
if (isset($_REQUEST['status'])) {
  ...
  $sqlStatus = $db->execute("UPDATE `product_type` SET `status` = '$status' WHERE `id` = '$id'");
...
<head>
  ...
  <title><?php echo $websiteTitle; ?> | View Product Type</title>
  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      <section class="content-header">
        <h1> Manage Product Type <small>View Product Type</small> </h1>
        <ol class="breadcrumb">
          ...
          <div class="col-xs-12">
            <div class="box">
              <div class="box-header">
                <h3 class="box-title">View Product Type</h3>
              </div>
              <div class="box-body">
