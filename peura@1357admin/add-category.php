...
if (isset($_REQUEST['submit'])) {
  ...
  $slug = $admin->slug($name, 'category');

  if ($checkCategory == 0) {
    $result = $admin->addCategories($name, $slug, $status);
...
if (isset($_REQUEST['update'])) {
  ...
  $slug = $admin->updateSlug($name, 'category', $id);
  $result = $admin->updateCategories($name, $slug, $status, $id);
...
<html>
  ...
  <head>
    ...
    <title><?= $websiteTitle; ?> | Add Category</title>
                    ...
                    <?php else: ?>
                        <form name="mycategory" id="mycategory" method="post" class="form-horizontal" enctype="multipart/form-data">
                          ...
                          <div class="form-group">
                            <label for="inputName" class="col-sm-2 control-label">Name</label>
                            <div class="col-sm-6">
                              <input type="text" name="name" value="<?= $editval['name'] ?>" class="form-control" placeholder="Category Name" required>
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="inputName" class="col-sm-2 control-label">Status</label>
