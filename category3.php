								...
								<select id="product-type-filter" class="styled-dropdown"  style=" width: 200px; border: 1px solid rgba(0, 0, 0, 0.3); border-radius:.3rem ;">
									...
									<?php
										...
										foreach ($sqlTypeQuery as $sqlTypeRow):
											$rowCount = $productTypes->getProductTypeByPro($sqlTypeRow['id']);
							...
							<div class="col-12 tab-content shop-" id="pills-tabContent">
								...
								<div class="tab-pane fade active show" id="tab-list-grid" role="tabpanel" aria-labelledby="tab-list-grid-btn">
									...
									<?php
										...
										// Now you have an array of product_type_ids
										// You can loop through or use the product type IDs as needed
										...
										<div class="col-6 col-xl-3 col-lg-4 col-md-4 col-sm-6 m-md-b15 m-b30">
											<div class="shop-card style-1">
												...
												<div class="dz-content">
													<h5 class="title"><a href="product-detail.php?id=<?php echo base64_encode($ProRow['product_id']) ?>"><?php echo htmlspecialchars($ProRow['name']);
																																									echo '  Product Type Names: ';
																																									foreach ($productTypeIdsArray as $typeId) {
																																										$typeRow=$productTypes->getProductTypeById($typeId);
																																										echo $typeRow['name'] . ' ';
																																									}
																																									?></a></h5>
